...
What to document, and where. The documentation that happens during the response is the input to the [post-incident](../../incident-response/sirt/learning.md) review and the compliance record. If it requires a separate effort after the fact, it will be incomplete.
