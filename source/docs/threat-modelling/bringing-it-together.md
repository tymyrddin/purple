...
Before closing, address this directly: who in the room has the authority and the capacity to [act on each priority finding](../practice/acting-on-findings.md)? If the answer for a critical finding is "nobody present," then either the right person needs to be brought into the conversation or the finding needs to be escalated. A threat model whose highest-priority findings have no owner is a document, not a programme.
