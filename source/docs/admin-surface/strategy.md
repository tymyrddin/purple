...
The three
cases, [Radarstation Herwijnen](herwijnen.md), [Maintenance tender for secured network rooms](netwerkruimtes.md) and the [Defensie Pijpleiding Organisatie (DPO) fuel pipeline](dpo.md),
together with the [proof-of-concept design SOS](sos.md), all point at the same finding.
...
system could look like, using Dutch public sources, is sketched in [SOS](sos.md). A working prototype could be built in a
matter of weeks.
