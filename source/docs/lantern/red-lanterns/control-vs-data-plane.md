...
([Fat finger hijack](https://red.tymyrddin.dev/docs/scarlet/op-red-lantern/fat_finger_hijack): This is not an attack on authority. It is a mistake that the system is 
...
[Control-Plane Poisoning with Operational Cover](https://red.tymyrddin.dev/docs/scarlet/op-red-lantern/roa_poisoning): Valid routes are rejected. Invalid routes are 
