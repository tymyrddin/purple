...
First, to take the abstract attack trees that decorate our shelves and turn them into concrete sequences of actions that a human being might actually perform under time pressure, fatigue, and budgetary constraint.
