...
This framework gives everything needed to understand *how* the city responds to crises, without requiring numerical balance. The Patrician's decisions become meaningful trade-offs:
