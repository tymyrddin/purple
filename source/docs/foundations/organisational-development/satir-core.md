...
Distracting: deflecting, changing the subject, disengaging. This shows up as an organisational tendency to treat 
security concerns as someone else's problem until they become impossible to ignore.

## Congruence

Congruence is alignment between what one says, what one feels, what one intends, and what the context requires. Many 
call that "authenticity" for short. It is both goal of healthy communication and diagnostic for its absence.

In an organisation, incongruence can show up in a gap between stated policy and actual practice, between incident 
response plan and what happens in an actual incident, between a security culture described in recruitment materials 
...
environment do not reach the people who need to act on it.
