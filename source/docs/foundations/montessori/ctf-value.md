...
The useful questions are: what was surprising about how the technique worked, what would have caused it to fail, what detection opportunity did it create, and what does this change about how you would approach this technique in a real environment.
