...
service of the learning rather than the other way round. The formats below are common ones, each suited to a
different kind of practice.

## Capture the flag

[The jeopardy style](ctf-value.md) is the familiar one: categories of challenges across web, crypto, forensics, reverse engineering,
...
operational security and the discomfort of patching under live pressure. It sits closer to real operations
...
[Incident response simulations](hands-on.md) drop a team into a realistic incident and judge the response on speed, accuracy,
