...
Accept: consciously decide to live with the risk. Acceptance is legitimate for low risks, or for risks where treatment would cost more than the exposure. The key word is "consciously": acceptance should be an explicit decision made by someone with the authority to make it, not a default outcome of inaction.
...
Be honest about feasibility. "Implement MFA" is not a treatment plan for an organisation that does not have the budget to license an identity provider or the technical capacity to configure one. The exercise should surface feasibility constraints, not paper over them.
