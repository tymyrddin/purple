...
* [OCTAVE](https://pecb.com/en/whitepaper/risk-assessment-with-octave) is a self-directed method focused on aligning risks with organisational goals. It looks beyond technology to strategy, culture, and practices, and suits organisations that want business stakeholders directly involved in identifying and prioritising risks instead of leaving it to IT. The most accessible starting point for organisations without a dedicated risk team.
...
Treating risk scenarios as assumptions to verify is what makes risk assessment
...
* Avoidance eliminates the risk by not engaging in the activity: no BYOD at all instead of an elaborate BYOD control stack, an on-premises store over a cloud provider whose misconfiguration risk outweighs its savings.
