...
A Montessori prepared environment is one in which the materials for learning are arranged so that the learner can encounter what they need to encounter, at the right level of challenge, without unnecessary obstacles and without unnecessary scaffolding. The point of preparation is not to make things easy; it is to make them possible.
