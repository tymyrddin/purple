...
Gaps discovered during exercises lead to finger-pointing. An analyst who missed an alert is identified. A team
that left a system unpatched is named. The exercise reflection becomes a retrospective accountability exercise
with no one coming away eager to participate in the next one.

Purple teaming reveals organisational weaknesses, not personal failures. An analyst who missed an alert was
