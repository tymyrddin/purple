...
This is operational fragility, and it is structurally different from the familiar cloud security failure
modes. It is not an attacker exploiting a misconfiguration. It is a legitimate user, with legitimate credentials,
...
[CI/CD exposure](cicd-exposure.md) covers the deployment-pipeline version of this question: a pipeline with the
...
[Identity collapse](identity-collapse.md) covers the credential-and-permissions version: who has the right to
do what, and whether the answer reflects the cost of getting it wrong.

[Shared responsibility](shared-responsibility.md) covers the contractual version: the line between what the
